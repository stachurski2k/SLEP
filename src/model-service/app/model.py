"""Sequence encoder architecture. Ported from research/test_version/Models/Transformer_encoder.py
so this service does not depend on the research project at runtime.
"""
import torch
