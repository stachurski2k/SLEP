...
\input{chapters/01_introduction_pl}
\input{chapters/02_related_work_pl}
\input{chapters/03_annotation_platform_pl}
\input{chapters/04_isolated_gloss_recognition_pl.tex}
\input{chapters/05_text_translation_pl}
\input{chapters/06_sentence_level_translation_pl}
\input{chapters/07_educational_platform_pl}
\input{chapters/08_conclusions_pl}
\input{chapters/09_bibliography}
\input{chapters/10_appendices_pl}
